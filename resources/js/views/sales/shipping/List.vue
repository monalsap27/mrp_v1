<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link :to="'/sales-shipping/create'">
        <el-button
          class="filter-item"
    ...
    >
      ...
      <el-table-column align="center" label="Actions" width="150">
        <template #default="scope">
          ...
          <router-link :to="'/sales-shipping/detailShipment/' + scope.row.id">
...
import { fetchDeliveryOrder, StartShipment } from '@/api/sales/delivery_order';
