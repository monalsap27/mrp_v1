<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="No Transaction" prop="nomor" />
      ...
      <el-table-column align="center" label="Actions" width="150">
        <template #default="scope">
          <span v-if="scope.row.status == 1">
            <router-link
              :to="'/vendor-request/detailConfirmation/' + scope.row.id"
            >
          ...
          <router-link
            :to="'/vendor-request/detailTransaction/' + scope.row.id"
          >
...
import { fetchListRequest } from '@/api/vendor/request';
