<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link :to="'/production-workstation/create-group'">
        <el-button
          class="filter-item"
    ...
    >
      ...
      <el-table-column align="center" label="Total Timing">
        <template slot-scope="scope">
          <span>{{ scope.row.total_timing }}</span>
        </template>
      </el-table-column>

      <el-table-column align="center" label="Total Workforce">
        <template slot-scope="scope">
...
import {
  fetchList,
  DeleteWorkstation,
} from '@/api/production/workstation_group';
