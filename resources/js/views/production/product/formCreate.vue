            ...
            <el-row>
              <el-col :span="12">
                <div style="display: inline-block">
                  ...
                  <el-radio-group v-model="newProduct.type">
        ...
        <el-card v-show="dialogDetailVisible" class="box-card">
          ...
          >
            ...
            <el-table-column
              ...
              width="100"
            />
            <el-table-column align="center" label="Timing" width="150">
              <template #default="scope">
                <template v-if="scope.row.edit">
                  <el-input-number
...
export default {
  ...
  methods: {
    ...
    async onShowWorkstation(event) {
      ...
      this.listWorkStasion = data;
      this.listWorkStasion.forEach((element, index) => {
        this.newProduct.items.push({
