<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <h1 style="text-align: center; color: blue; margin-top: -100px; margin-bottom: 5rem;"><img src="../../../../assets/logocobra2.png" width="15%" alt=""></h1>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <a href="https://github.com/tuandm/laravue/"><div class="card-panel">
