        ...
        <div class="row">
          ...
          >
            <div class="page-title home text-center">
              <span class="heading-page"> Welcome to MRP </span>
            </div>
            ...
            <div class="hexagon-menu clear">
              <div class="hexagon-item">
                ...
                <a class="hex-content" @click="admin">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i>
                        <svg-icon
                          icon-class="users-alt"
              ...
              <div class="hexagon-item">
                ...
                <a class="hex-content" @click="production">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i>
                        <svg-icon
                          icon-class="industry-alt-black"
                          class-name="card-panel-icon"
                        />
                      </i>
                    </span>
              ...
              <div class="hexagon-item">
                ...
                <a class="hex-content" @click="purchasing">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i>
                        <svg-icon
                          icon-class="shopping-cart-add-black"
                          class-name="card-panel-icon"
                        />
                      </i>
                    </span>
              ...
              <div class="hexagon-item">
                ...
                <a class="hex-content" @click="vendor">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i>
                        <svg-icon
                          icon-class="store-alt"
                          class-name="card-panel-icon"
                        />
                      </i>
                    </span>
              ...
              <div class="hexagon-item">
                ...
                <a class="hex-content" @click="sales">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i>
                        <svg-icon
                          icon-class="badge-percent"
                          class-name="card-panel-icon"
                        />
                      </i>
                    </span>
              ...
              <div class="hexagon-item">
                ...
                <a class="hex-content" @click="customer">
                  <span class="hex-content-inner">
                    <span class="icon">
                      <i>
                        <svg-icon
...
export default {
  methods: {
    ...
    async purchasing() {
      this.$router.push({ path: '/purchasing' }).then(() => {
        this.$router.go();
      });
    },
    async vendor() {
      this.$router.push({ path: '/vendor' }).then(() => {
        this.$router.go();
      });
    },
    async customer() {
      this.$router.push({ path: '/customer' }).then(() => {
        this.$router.go();
      });
    },
    async sales() {
      this.$router.push({ path: '/sales' }).then(() => {
        this.$router.go();
      });
    },
...
.hexagon-item:hover .hex-content .icon-hexa {
